...
export function ToolCallCard({ toolName, content, timestamp }: ToolCallCardProps) {
  ...
  return (
    <div className="flex gap-2 animate-slide-in">
      ...
      <div className="bg-amber-950/20 border border-amber-500/30 rounded-lg overflow-hidden text-xs max-w-[92%] w-full">
        <div
        ...
        {isOpen ? (
          <div className="p-3 bg-black/70 border-t border-amber-500/20 font-mono text-[11px] text-zinc-300 overflow-x-auto whitespace-pre-wrap max-h-60 leading-relaxed">
            {content}
          </div>
        ) : (
